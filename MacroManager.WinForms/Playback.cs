...
namespace MacroManager.WinForms
{
    public partial class Playback : UserControl
    {
        ...
        private void playbackService_ActionError(object sender, PlaybackService.ErrorEventArgs args)
        {
            ...
            MessageBox.Show(
                " Execution terminated.\r\n\r\nMessage: " + args.ErrorMessage == "" ? "An action could not be performed!" : args.ErrorMessage,
                "Error...",
        ...
        private void InitializeActionIcons()
        {
            if (this.actionIcons == null)
            {
                ...
                this.actionIcons.Images.Add(
                    "waiting", 
                    Image.FromStream(assembly.GetManifestResourceStream("MacroManager.WinForms.Icons.clock.png"))
                );
                this.actionIcons.Images.Add(
                    "executing",
                    Image.FromStream(assembly.GetManifestResourceStream("MacroManager.WinForms.Icons.cog.png"))
                );
                this.actionIcons.Images.Add(
                    "done",
                    Image.FromStream(assembly.GetManifestResourceStream("MacroManager.WinForms.Icons.accept.png"))
                );
                this.actionIcons.Images.Add(
                    "error",
                    Image.FromStream(assembly.GetManifestResourceStream("MacroManager.WinForms.Icons.exclamation.png"))
                );
